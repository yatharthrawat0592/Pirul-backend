...
public class JwtUtils {
    ...
    public String generateJwtToken(Authentication authentication) {
        ...
        return Jwts.builder().setSubject((userPrincipal.getUsername())).setIssuedAt(new Date()).setExpiration(expirationDate).signWith(key(), SignatureAlgorithm.HS256).compact();
    }
